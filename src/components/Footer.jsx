...
const Footer = () => {
  return (
    <footer className="text-center border-t border-gray-200 dark:border-gray-800 pt-8">
      <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">Eduardo Sato</h3>
      <p className="text-gray-600 dark:text-gray-400 mb-6">Desenvolvedor FullStack</p>
