...
import { MapPin, Linkedin, Github, ExternalLink, Loader2, Mail } from 'lucide-react'
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className={`w-full px-3 py-2 bg-white dark:bg-gray-800 border text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 ${errors.name ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                }`}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              className={`w-full px-3 py-2 bg-white dark:bg-gray-800 border text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 ${errors.email ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                }`}
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              required
              className={`w-full px-3 py-2 bg-white dark:bg-gray-800 border text-gray-900 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-sky-500 ${errors.message ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
                }`}
